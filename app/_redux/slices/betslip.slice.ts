...
const betSlipSlice = createSlice({
  ...
  reducers: {
    ...
    updateWinnings(state, action: PayloadAction<any>) {
      ...
      console.log(stake, globalVars, id, "*stake");
      ...
      if (stake !== "") {
        if (
          ...
          if (id === "all") {
            ...
            state.coupon.stake = stake;
            state.coupon.totalStake = stake;
            state.coupon.maxWin = selections[0].odds * stake;
            // state.coupon.minWin = 0;
          } else {
