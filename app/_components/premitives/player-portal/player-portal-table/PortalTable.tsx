      ...
      <Form
        ...
        render={({ handleSubmit }) => (
          <form onSubmit={handleSubmit} className="port_table_form_wrap">
            ...
            <div className="port_table_input_wrap">
            ...
            data?.data?.map((item: any, idx: number) => (
              ...
              >
                ...
                <div className="between port_table_acc_con">
                  ...
                  <div className="table_acc_wrap">
                  {item.type === 'credit' && <div className="table_acc_title">NGN <span style={{color: 'green'}}>+{item?.amount}</span></div>}
                  {item.type === 'debit' && <div className="table_acc_title">NGN <span style={{color: 'red'}}>-{item?.amount}</span></div>}
                  </div>
                </div>
                <div className="between port_table_acc_con">
                  <div className="table_acc_wrap start">
                ...
                <div className="between port_table_acc_con">
                  ...
                  <div className="table_acc_wrap">
                    <div className="table_acc_title">
                      {item.status === 0 && <span style={{color: 'orange'}}>Pending</span>}
                      {item.status === 1 && <span style={{color: 'green'}}>Completed</span>}
                      {item.status === 2 && <span style={{color: 'red'}}>Failed/Cancelled</span>}
                    </div>
                  </div>
                </div>
              </div>
