...
const PlacedBets = () => {
  ...
  const [betList, { data: data1, isLoading }] = useBetListMutation();
  const [betList2, { data: data2 }] = useBetList2Mutation();
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      rtkMutation(betList2, filterData);
    }, 15000);
  ...
  useEffect(() => {
    ...
    rtkMutation(betList, filterData);
  }, [user]);
