            ...
            <div className="quicklinks__holder">
                <div className="quicklinks__list">
                    <div className="quicklinks__item" id="iconslider_1539_soccer_element">
                        <NavLink to={'/sport/soccer/1'} className="quicklinks__icon" id="iconslider_1539_soccer_link">
                            <i className="icon" style={{backgroundImage: 'url(/img/soccer.svg)', width: '24px', height: '24px'}}/>
                        </NavLink>
                    ...
                    <div className="quicklinks__item" id="iconslider_321892_zoom_element">
                        <NavLink to={'/sport/livebetting'} className="quicklinks__icon" id="iconslider_321892_zoom_link">
                            <i className="icon" style={{backgroundImage: 'url(/img/livebetting.svg)', width: '24px', height: '24px'}}/>
                        </NavLink>
                    ...
                    <div className="quicklinks__item" id="iconslider_321892_zoom_element">
                        <NavLink to={'/dailybundle/soccer'} className="quicklinks__icon" id="iconslider_321892_zoom_link">
                            <i className="icon" style={{backgroundImage: 'url(/img/todays_matches.svg)', width: '24px', height: '24px'}}/>
                        </NavLink>
                    ...
                    <div className="quicklinks__item" id="iconslider_321892_zoom_element">
                        <NavLink to={'/coupon-check'} className="quicklinks__icon" id="iconslider_321892_zoom_link">
                            <i className="icon" style={{backgroundImage: 'url(/img/checkcoupon.svg)', width: '24px', height: '24px'}}/>
                        </NavLink>
                        <span className="quicklinks__item-label">Check a Bet</span>
                    </div>
                    <div className="quicklinks__item" id="iconslider_1544_book_a_bet_element">
                        <NavLink to={'/book-a-bet'} className="quicklinks__icon" id="iconslider_1544_book_a_bet_link">
                            <i className="icon" style={{backgroundImage: 'url(/img/bookabet.svg)', width: '24px', height: '24px'}}/>
                        </NavLink>
                        <span className="quicklinks__item-label">Book a Bet</span>
                    </div>
                    <div className="quicklinks__item" id="iconslider_321892_zoom_element">
                        <NavLink to={'/BecomeAnAgent/Register'} className="quicklinks__icon" id="iconslider_321892_zoom_link">
                            <i className="icon" style={{backgroundImage: 'url(/img/become-an-agent.png)', width: '24px', height: '24px'}}/>
                        </NavLink>
                        <span className="quicklinks__item-label">Become an Agent</span>
                    </div>
                    <div className="quicklinks__item" id="iconslider_1548_help_element">
                        <NavLink to={'/pages/how-to-play'} className="quicklinks__icon"
                           id="iconslider_1548_help_link">
                            <i className="icon" style={{backgroundImage: 'url(/img/help.svg)', width: '24px', height: '24px'}} />
                        </NavLink>
                        <span className="quicklinks__item-label">Help</span>
                    </div>
                    <div className="quicklinks__item" id="iconslider_1548_help_element">
                        <NavLink to={'/pages/contact-us'} className="quicklinks__icon"
                           id="iconslider_1548_help_link">
                            <i className="icon" style={{backgroundImage: 'url(/img/contactus.svg)', width: '24px', height: '24px'}} />
                        </NavLink>
