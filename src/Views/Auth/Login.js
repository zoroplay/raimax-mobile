      ...
      <div className="login-form">
        ...
        <div className="login-form__wrap">
          <div className="login-form__heading">
            <div>
              <a href="javascript:;" className="login-form__heading--lg" style={{pointerEvents: 'none'}}>Login</a>
            </div>
            <div><NavLink to="/register" className="login-form__heading--rg">Register</NavLink></div>
          </div>
            ...
            <div className="dnxreg-box-b">
              <div className="nxmob">
                ...
                <input className="form-input" type="text" autoComplete="username"
                       placeholder="Username" value={username} onChange={(e) => {setUsername(e.target.value); setError(false); setErrMsg(false)} } />
              </div>
            </div>
          </div>
          ...
          <button className="btn w-full mt15" onClick={(e) => submitForm(e)}>Login</button>
